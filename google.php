<?php include 'header.php'; ?>
    ...
    <div class="jumbotron">
        <h1>Google</h1>
        <p>Adres:  Claude Debussylaan 34, 1082 MD Amsterdam <br>
        Telefoon: 020 504 5100</p>
        ...
        <script type="text/javascript">
            var locations = [
                ['Google Hoofdkantoor', 52.337767 , 4.872392, 1],
            ];

            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 10,
                center: new google.maps.LatLng(52.362804, 4.876261),
