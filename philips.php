<?php include 'header.php'; ?>
    ...
    <div class="jumbotron">
        <h1>Philips</h1>
        <p>Adres: Bezuidenhoutseweg 12, 2594 AV Den Haag <br>
            Telefoon: 070 345 0400<br>
        ...
        <script type="text/javascript">
            var locations = [
                ['Google Hoofdkantoor', 52.084049 , 4.326386, 1],
            ];

            var map = new google.maps.Map(document.getElementById('map'), {
                zoom: 10,
                center: new google.maps.LatLng(52.084049, 4.326386),
